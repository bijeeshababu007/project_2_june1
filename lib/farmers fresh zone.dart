...
class FarmersFreshZone extends StatelessWidget {
  ...
  var images =["https://cdn.britannica.com/16/187216-050-CB57A09B/tomatoes-tomato-plant-Fruit-vegetable.jpg",
          ...
          child: Column(
            children: [
              Container(
                ...
                padding: EdgeInsets.only(right: 25,left: 20,top: 15),
                child :Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text("FARMERS FRESH ZONE",style: TextStyle(
                      fontSize: 25,
                      color: Colors.white,
             ...
             child: TabBarView(
              ...
              Container(
               child: Column(children: [
                 Image.asset("assets/images/veg.jpg",height: 600,
                 fit: BoxFit.cover,),
               ],
                ),
              ),
              ...
              decoration: BoxDecoration(
                ...
                children: [
                  ...
                  decoration: BoxDecoration(
                    ...
                    child: Image.network("https://cdn-icons-png.flaticon.com/512/27/27133.png",
                    fit: BoxFit.cover,),
                  )
                ],),
              ),
